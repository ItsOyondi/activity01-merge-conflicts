...
**Response**: There were more movies that failed the bechdel test than those that passed the test both domestic and international
...
**Response**: Based on med_budget, Ok (passed the test) were the least whereas the 'ok' ones were second least after 'nowomen' as indicated by mid_domgross.Furthermore, med_domgross has the greatest values than med_budget.
...
**Response**: The return on 'OK' movies, was significantly higher than the nowomen, notalk, men and dubious movies.
